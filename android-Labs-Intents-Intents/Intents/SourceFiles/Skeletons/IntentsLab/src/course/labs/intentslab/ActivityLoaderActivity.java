...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent expIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		Intent impInt = new Intent(Intent.ACTION_VIEW , Uri.parse(URL));
		...
		Intent chooserIntent = Intent.createChooser(impInt, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK){
			mUserTextView.setText(data.getStringExtra("MESSAGE"));
		}
